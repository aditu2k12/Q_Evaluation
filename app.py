...
nlp = spacy.load('spacy_nlp_model/content/spacy_nlp_model')

model = sentence_transformers.SentenceTransformer('saved_transformer_model')
...
def predict():
  ...
  return pd.Series(predictions).to_dict()
